...
- [x] H2B: Home Tasks schema and due-state domain logic
  - [x] Add tests for monthly/yearly recurrence edge cases, including month-end dates.
  - [x] Decide and implement month-end recurrence behaviour, for example 31 Jan -> 28/29 Feb rather than JS Date rollover into March.
